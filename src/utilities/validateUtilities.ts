...
export function validateRows(grid: SudokuGridModel): ValidationIssue[] {
...
export function validateColumns(grid: SudokuGridModel): ValidationIssue[] {
  const issues: ValidationIssue[] = [];
...
export function validateBlocks(grid: SudokuGridModel): ValidationIssue[] {
  const issues: ValidationIssue[] = [];
...
export function validateGrid(grid: SudokuGridModel): ValidationIssue[] {
  const issues: ValidationIssue[] = [];
...
export const validateUtilities = {
  validateGrid,
};
